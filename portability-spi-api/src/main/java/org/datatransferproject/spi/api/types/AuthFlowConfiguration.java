...
public class AuthFlowConfiguration extends PortableType {
     ...
     */
    @JsonCreator
    public AuthFlowConfiguration(@JsonProperty("authUrl") String authUrl, @JsonProperty("tokenUrl") String tokenUrl, @JsonProperty("authProtocol") AuthProtocol authProtocol, @JsonProperty("initialAuthData") AuthData initialAuthData) {
        this.authUrl = authUrl;
        this.tokenUrl = tokenUrl;
        this.authProtocol = authProtocol;
