...
public interface DtpInternalMetricRecorder {
     ...
     * A DTP job finished *
     */
    void finishedJob(DataVertical dataType, String exportService, String importService, boolean success, Duration duration);

    /**
     * A DTP job cancelled *
     */
    void cancelledJob(DataVertical dataType, String exportService, String importService, Duration duration);

    /**
     * An single attempt to export a page of data finished. *
     */
    void exportPageAttemptFinished(DataVertical dataType, String service, boolean success, Duration duration);
     ...
     */
    void importPageAttemptFinished(DataVertical dataType, String service, boolean success, Duration duration);
