...
import org.dataportabilityproject.datatransfer.types.auth.AuthFlowConfiguration;

/**
 * Generates data for authentication flows.
 *
 * REVIEW: removed IOException
 */
public interface AuthDataGenerator {
     ...
     */
    AuthData generateAuthData(String callbackBaseUrl, String authCode, String id, AuthData initialAuthData, String extra);
}
