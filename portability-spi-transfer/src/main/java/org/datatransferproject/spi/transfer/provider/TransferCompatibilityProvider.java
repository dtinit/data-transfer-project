...
public class TransferCompatibilityProvider {
    ...
    private Exporter<?, ?> getVideosExporter(TransferExtension extension) {
        ...
        Function<ContainerResource, ContainerResource> converter = (cr) -> (cr instanceof VideosContainerResource) ? MediaContainerResource.videoToMedia((VideosContainerResource) cr) : cr;
    ...
    private Exporter<?, ?> getPhotosExporter(TransferExtension extension) {
        ...
        Function<ContainerResource, ContainerResource> converter = (cr) -> (cr instanceof PhotosContainerResource) ? MediaContainerResource.photoToMedia((PhotosContainerResource) cr) : cr;
