...
public interface CachingExecutor {
     ...
     */
    @Nullable
    <T extends Serializable> T executeAndSwallowIOExceptions(String idempotentId, String itemName, Callable<T> callable) throws Exception;
     ...
     * @return the result of executing the callable.
     */
    <T extends Serializable> T executeOrThrowException(String idempotentId, String itemName, Callable<T> callable) throws Exception;
