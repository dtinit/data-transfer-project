...
public class PhotosContainerResourceTest {
    ...
    public void verifyTransmogrifyAlbums_evenDivision() throws Exception {
        ...
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic4", "http://fake.com/3.jpg", "A pic", "image/jpg", "p4", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", "id1", false));
        PhotosContainerResource data = new PhotosContainerResource(albums, photos);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyAlbums_oddDivisionWithLoosePhotos() throws Exception {
        ...
        List<PhotoAlbum> albums = ImmutableList.of(new PhotoAlbum("id1", "albumb1", "This is a fake album"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic4", "http://fake.com/3.jpg", "A pic", "image/jpg", "p4", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", null, false), new PhotoModel("Pic5", "https://fake.com/pic.png", "fine art", "image/png", "p5", null, false), new PhotoModel("Pic6", "https://fake.com/pic.png", "fine art", "image/png", "p6", null, false));
        PhotosContainerResource data = new PhotosContainerResource(albums, photos);
        data.transmogrify(config);
        Truth.assertThat(data.getAlbums()).hasSize(2);
    ...
    public void verifyTransmogrifyAlbums_oddDivisionWithoutLoosePhotos() throws Exception {
        ...
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic2", "https://fake.com/pic2.png", "fine art", "image/png", "p2", null, false), new PhotoModel("Pic5", "https://fake.com/pic5.png", "fine art", "image/png", "p5", null, false), new PhotoModel("Pic6", "https://fake.com/pic6.png", "fine art", "image/png", "p6", null, false));
        PhotosContainerResource data = new PhotosContainerResource(albums, photos);
        data.transmogrify(config);
        Truth.assertThat(data.getAlbums()).hasSize(2);
        Truth.assertThat(data.getAlbums().stream().map(thing -> thing.getName()).collect(Collectors.toList())).isEqualTo(ImmutableList.of("Transferred Photos (1/2)", "Transferred Photos (2/2)"));
        Truth.assertThat(data.getPhotos()).hasSize(3);
    }
