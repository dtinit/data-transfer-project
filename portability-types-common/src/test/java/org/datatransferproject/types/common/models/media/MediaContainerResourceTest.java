...
public class MediaContainerResourceTest {
    ...
    public void verifySerializeDeserialize() throws Exception {
        ...
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This is a fake albumb"));
        ...
        ContainerResource data = new MediaContainerResource(albums, photos, null);
    ...
    public void verifyTransmogrifyAlbums_nullName() throws Exception {
        ...
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
    ...
    public void verifyTransmogrifyAlbums_NoLimit() throws Exception {
        TransmogrificationConfig config = new TransmogrificationConfig();
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This is a fake album"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", "id1", false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyAlbums_NoRootPhotos() throws Exception {
        ...
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This is a fake album"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", null, false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyAlbums_NameForbiddenCharacters() throws Exception {
        ...
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic2.png", "fine art", "image/png", "p2", null, false), new PhotoModel("Pic5", "https://fake.com/pic5.png", "fine art", "image/png", "p5", null, false), new PhotoModel("Pic6", "https://fake.com/pic6.png", "fine art", "image/png", "p6", null, false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyPhotos_TitleForbiddenCharacters() throws Exception {
        ...
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1!", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic:3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", null, false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyPhotos_TitleNoForbiddenCharacters() throws Exception {
        TransmogrificationConfig config = new TransmogrificationConfig();
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic?1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic:3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("Pic2", "https://fake.com/pic.png", "fine art", "image/png", "p2", null, false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyPhotos_TitleTooLong() throws Exception {
        ...
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false), new PhotoModel("P2", "https://fake.com/pic.png", "fine art", "image/png", "p2", null, false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
    ...
    public void verifyTransmogrifyPhotos_stripTitle() throws Exception {
        TransmogrificationConfig config = new TransmogrificationConfig();
        List<MediaAlbum> albums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1 ", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3 ", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false));
        MediaContainerResource data = new MediaContainerResource(albums, photos, null);
        data.transmogrify(config);
        Truth.assertThat(Iterables.get(data.getPhotos(), 0).getTitle()).isEqualTo("Pic1");
    ...
    public void verifyPhotoToMediaContainer() throws Exception {
        TransmogrificationConfig config = new TransmogrificationConfig();
        List<PhotoAlbum> givenPhotoAlbum = ImmutableList.of(new PhotoAlbum("id1", "albumb1", "This:a fake album!"));
        List<MediaAlbum> expectedMediaAlbum = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        ...
        Truth.assertThat(givenPhotoAlbum.stream().map(a -> a.getId()).collect(Collectors.toList())).containsExactlyElementsIn(expectedMediaAlbum.stream().map(a -> a.getId()).collect(Collectors.toList()));
        Truth.assertThat(givenPhotoAlbum.stream().map(a -> a.getName()).collect(Collectors.toList())).containsExactlyElementsIn(expectedMediaAlbum.stream().map(a -> a.getName()).collect(Collectors.toList()));
        Truth.assertThat(givenPhotoAlbum.stream().map(a -> a.getDescription()).collect(Collectors.toList())).containsExactlyElementsIn(expectedMediaAlbum.stream().map(a -> a.getDescription()).collect(Collectors.toList()));
        List<PhotoModel> photos = ImmutableList.of(new PhotoModel("Pic1 ", "http://fake.com/1.jpg", "A pic", "image/jpg", "p1", "id1", false), new PhotoModel("Pic3 ", "http://fake.com/2.jpg", "A pic", "image/jpg", "p3", "id1", false));
    ...
    public void verifyMediaToPhotoContainer() throws Exception {
        ...
        Truth.assertThat(generatedPhotoData.getAlbums().stream().map(a -> a.getId()).collect(Collectors.toList())).containsExactlyElementsIn(albums.stream().map(a -> a.getId()).collect(Collectors.toList()));
        Truth.assertThat(generatedPhotoData.getAlbums().stream().map(a -> a.getName()).collect(Collectors.toList())).containsExactlyElementsIn(albums.stream().map(a -> a.getName()).collect(Collectors.toList()));
        Truth.assertThat(generatedPhotoData.getAlbums().stream().map(a -> a.getDescription()).collect(Collectors.toList())).containsExactlyElementsIn(albums.stream().map(a -> a.getDescription()).collect(Collectors.toList()));
        Truth.assertThat(generatedPhotoData.getPhotos()).containsExactlyElementsIn(photos);
    }

    @Test
    public void verifyMediaToVideoContainer() {
        List<MediaAlbum> mediaAlbums = ImmutableList.of(new MediaAlbum("id1", "albumb1", "This:a fake album!"));
        List<VideoAlbum> videoAlbums = ImmutableList.of(new VideoAlbum("id1", "albumb1", "This:a fake album!"));
        List<VideoModel> videos = ImmutableList.of(new VideoModel("Vid1", "http://fake.com/1.mp4", "A vid", "mediatype", "p1", "id1", false, null), new VideoModel("Vid3", "http://fake.com/2.mp4", "A vid", "mediatype", "p3", "id1", false, null));
