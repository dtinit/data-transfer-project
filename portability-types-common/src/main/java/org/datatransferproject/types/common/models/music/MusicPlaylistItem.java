...
public class MusicPlaylistItem {
    ...
    @JsonCreator
    public MusicPlaylistItem(@JsonProperty("track") MusicRecording track, @JsonProperty("playlistId") String playlistId, @JsonProperty("order") int order) {
        Preconditions.checkArgument(track != null, "track must be set for MusicPlaylistItem");
        this.track = track;
        Preconditions.checkArgument(!isNullOrEmpty(playlistId), "non-empty playlistId must be set for MusicPlaylistItem");
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("track", getTrack()).add("playlistId", getPlaylistId()).add("order", getOrder()).toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(track, that.track) && Objects.equals(playlistId, that.playlistId) && order == that.order;
    }
