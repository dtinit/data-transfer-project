...
public class ExportInformation extends PortableType {
     ...
     */
    @JsonCreator
    public ExportInformation(@JsonProperty("paginationData") PaginationData paginationData, @JsonProperty("containerResource") ContainerResource containerResource) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getPaginationData(), that.getPaginationData()) && Objects.equals(getContainerResource(), that.getContainerResource());
    }
