...
public abstract class LegacyPortabilityJob {
  ...
  @Nullable
  public abstract String exportAccount();

  @Nullable
  public abstract AuthData exportInitialAuthData();

  /** @deprecated Use encryptedExportAuthData when encrypted flow is implemented. */
  @Deprecated
  @Nullable
  public abstract AuthData exportAuthData();
  ...
  @Nullable
  public abstract String importAccount();

  @Nullable
  public abstract AuthData importInitialAuthData();

  /** @deprecated Use encryptedImportAuthData when encrypted flow is implemented. */
  @Deprecated
  @Nullable
  public abstract AuthData importAuthData();
  ...
  @Nullable
  public abstract String workerInstancePublicKey();

  @Nullable
  public abstract String workerInstancePrivateKey(); // TODO: Consider removing

  // TODO: Remove Nullable - jobState should never be null after we enable encryptedFlow everywhere
  @Nullable
  public abstract JobAuthorization.State jobState();
  ...
  public abstract static class Builder {
    ...
    @Deprecated
    public abstract LegacyPortabilityJob.Builder setExportAuthData(AuthData id);
    ...
    @Deprecated
    public abstract LegacyPortabilityJob.Builder setImportAuthData(AuthData id);
