...
public class ReferenceApiModule extends FlagBindingModule {
  ...
  public ReferenceApiModule(ApiSettingsExtension apiSettingsExtension) {
    super(apiSettingsExtension);
  }

  @Override
  protected void configure() {
    // binds flags from ApiSettingsExtension to @Named annotations
    super.configure();
