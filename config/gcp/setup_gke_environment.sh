...
create_backend_pool() { # args: ${1}: backend name, "api" or "worker"
  ...
  # -----------------------------------------------------------------------
  # The rest of the create_backend_pool() function pertains to API only!
  # This part sets up the ability to forward traffic to the API.
  # The worker pool doesn't receive traffic directly; it polls for jobs.
  # -----------------------------------------------------------------------
