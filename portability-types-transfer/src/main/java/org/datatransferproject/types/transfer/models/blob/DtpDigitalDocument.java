...
/**
 * This is intended to by a sub set of schema.org's DigitalDocumentWrapper (see:
 * https://schema.org/DigitalDocument). Additional fields from the schema.org spec should be added
 * as needed .
 */
