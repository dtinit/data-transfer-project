...
/**
 * Represents a folder in a blobby storage system such as Google Drive or Microsoft OneDrive. Can
 * contain multiple files (via {@link DigitalDocumentWrapper}) or folders (via nested
