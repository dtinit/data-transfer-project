...
public class PortabilityInMemoryDataCopierTest {
    ...
    private static class TestPortabilityInMemoryDataCopier extends PortabilityInMemoryDataCopier {
        ...
        public TestPortabilityInMemoryDataCopier() {
            super(null, null, null, Mockito.mock(Monitor.class), new FakeIdempotentImportExecutor(), null, null);
        }
    ...
    private static class TestPortabilityStackInMemoryDataCopier extends PortabilityStackInMemoryDataCopier {

        public TestPortabilityStackInMemoryDataCopier() {
            super(null, null, null, Mockito.mock(Monitor.class), new FakeIdempotentImportExecutor(), null, (Mockito.mock(JobStore.class)));
        }
    ...
    public static Iterable<PortabilityAbstractInMemoryDataCopier> data() {
        return Arrays.asList((new PortabilityAbstractInMemoryDataCopier[] { Mockito.spy(new TestPortabilityInMemoryDataCopier()), Mockito.spy(new TestPortabilityStackInMemoryDataCopier()) }));
    }
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void initialExportInfoIsNull(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        ...
        Mockito.verify(inMemoryDataCopier).copyIteration(jobId, exportAuthData, importAuthData, initialExportInfo, jobIdPrefix, 1);
    }

    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataIsNull(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
        ...
        Mockito.verify(inMemoryDataCopier).copyIteration(jobId, exportAuthData, importAuthData, Optional.of(exportInfo), jobIdPrefix, 1);
    }

    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithPaginationData(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithEmptySubResourceList(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithSingleSubResource(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithMultipleSubResources(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithPaginationDataAndMultipleSubResources(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
        PaginationData paginationData = Mockito.mock(PaginationData.class);
        ContainerResource subResource1 = Mockito.mock(ContainerResource.class);
        ContainerResource subResource2 = Mockito.mock(ContainerResource.class);
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void continuationDataWithPaginationDataAndNestedSubResource(PortabilityAbstractInMemoryDataCopier inMemoryDataCopier) throws CopyException, IOException {
        inMemoryDataCopier.resetCopyIterationCounter();
        PaginationData paginationData = Mockito.mock(PaginationData.class);
    ...
    public void doNotPerformAdditionalCopyingIfLoadingEmptyStackFromJobStore() throws CopyException, IOException {
        Mockito.when(stackInMemoryDataCopier.jobStore.loadJobStack(jobId)).thenReturn(Optional.of(new Stack<ExportInformation>()));
        stackInMemoryDataCopier.copy(exportAuthData, importAuthData, jobId, Optional.of(exportInfo));
        Mockito.verify(stackInMemoryDataCopier, Mockito.never()).copyIteration(Mockito.any(UUID.class), Mockito.any(AuthData.class), Mockito.any(AuthData.class), Mockito.any(Optional.class), Mockito.anyString(), Mockito.anyInt());
    }
}
