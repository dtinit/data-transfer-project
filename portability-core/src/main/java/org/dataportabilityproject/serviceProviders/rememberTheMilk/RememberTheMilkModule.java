...
public final class RememberTheMilkModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    mapbinder
        .addBinding(RememberTheMilkServiceProvider.class.getName())
        .to(RememberTheMilkServiceProvider.class);
  }
}
