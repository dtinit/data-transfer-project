...
public class PortabilityAuthServiceExtensionRegistryTest {
  ...
  public void requireImportAndExportTest() {
    ...
    AuthServiceExtension mockAuthProvider =
        getMockedAuthProvider(supportedImportTypes, supportedExportTypes, "mockAuthProvider");
  ...
  public void testGetTransferDataTypes() {
    ...
    AuthServiceExtension mockAuthProvider =
        getMockedAuthProvider(supportedServiceTypes, supportedServiceTypes, "mockAuthProvider");
  ...
  public void testGetExportServices1() {
    ...
    AuthServiceExtension mockAuthProvider1 =
        getMockedAuthProvider(supportedServiceTypes1, supportedServiceTypes1, "mockAuthProvider1");
    AuthServiceExtension mockAuthProvider2 =
        getMockedAuthProvider(supportedServiceTypes2, supportedServiceTypes2, "mockAuthProvider2");
  ...
  public void testGetAuthDataGenerator() {
    ...
    when(mockAuthProvider.getAuthDataGenerator(
            "CONTACTS", AuthServiceProviderRegistry.AuthMode.EXPORT))
