...
public class PortabilityAuthServiceExtensionRegistryTest {
    ...
    private AuthServiceExtension getMockedAuthProvider(List<DataVertical> supportedImportTypes, List<DataVertical> supportedExportTypes, String serviceId) {
    ...
    public void requireImportAndExportTest() {
        ...
        Throwable throwable = assertThrows(IllegalArgumentException.class, () -> {
            new PortabilityAuthServiceProviderRegistry(ImmutableMap.of("mockServiceProvider", mockAuthProvider));
        });
