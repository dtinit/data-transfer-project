...
final class ConfigureHandler implements HttpHandler {
  ...
  public void handle(HttpExchange exchange) throws IOException {
    ...
    DataTransfer dataTransfer = handleDataTransferExchange(exchange);
  ...
  DataTransfer handleDataTransferExchange(HttpExchange exchange) throws IOException{
    DataTransferRequest request = objectMapper.readValue(exchange.getRequestBody(), DataTransferRequest.class);
    return new DataTransfer(request.getSource(), request.getDestination(), request.getTransferDataType(),
        Status.INPROCESS, handleExchange(request, exchange));
  }

  String handleExchange(DataTransferRequest request, HttpExchange exchange) throws IOException {
