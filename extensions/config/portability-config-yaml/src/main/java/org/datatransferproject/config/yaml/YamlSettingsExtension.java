...
public class YamlSettingsExtension implements SettingsExtension {
    ...
    private InputStream getSimpleInputStream() {
        ImmutableList<String> settingsFiles = ImmutableList.<String>builder().add(COMMON_SETTINGS_PATH).add(ENV_COMMON_SETTINGS_PATH).add(API_SETTINGS_PATH).add(ENV_API_SETTINGS_PATH).add(EXTENSION_SETTINGS_PATH).add(TRANSFER_SETTINGS_PATH).add(ENV_TRANSFER_SETTINGS_PATH).build();
