...
public class ImgurPhotosExporter implements Exporter<TokensAndUrlAuthData, PhotosContainerResource> {
    ...
    public ImgurPhotosExporter(Monitor monitor, OkHttpClient client, ObjectMapper objectMapper, TemporaryPerJobDataStore jobStore, String baseUrl) {
    ...
    @VisibleForTesting
    public ImgurPhotosExporter(Monitor monitor, OkHttpClient client, ObjectMapper objectMapper, TemporaryPerJobDataStore jobStore, String baseUrl, Function<String, URL> urlFactory) {
        this.client = client;
     ...
     */
    private List<Map<String, Object>> requestData(TokensAndUrlAuthData authData, String url) throws IOException {
