...
public class ImgurPhotoExporterTest {
    ...
    private TokensAndUrlAuthData token = new TokensAndUrlAuthData("accessToken", "refreshToken", "tokenUrl");
    ...
    private static final PhotoModel ALBUM_PHOTO_1 = new PhotoModel("photo_1_name", "https://i.imgur.com/scGQp3z.jpg", "Photo 1", "image/jpeg", "album1Photo1", "albumId1", true);

    private static final PhotoModel ALBUM_PHOTO_2 = new PhotoModel(null, "https://i.imgur.com/HIBJYnE.jpg", null, "image/jpeg", "album1Photo2", "albumId1", true);

    private static final PhotoModel NON_ALBUM_PHOTO = new PhotoModel("non-album-photo-name", "https://i.imgur.com/eUMxy0R.jpg", null, "image/jpeg", "nonAlbumPhoto1", ImgurPhotosExporter.DEFAULT_ALBUM_ID, true);
...

    {
        try {
            ...
            album1ImagesResponse = Resources.toString(Resources.getResource("album_1_images.json"), Charsets.UTF_8).trim();
            allImagesResponse = Resources.toString(Resources.getResource("all_images.json"), Charsets.UTF_8).trim();
    ...
    public void setUp() throws IOException {
        ...
        server.start();
        exporter = new ImgurPhotosExporter(monitor, client, mapper, jobStore, server.url("").toString(), (urlString) -> {
            URL u = null;
            try {
