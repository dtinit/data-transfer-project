...
public class GoogleMailImporter implements Importer<AuthData, MailContainerResource> {
  ...
  @Override
  public ImportResult importItem(String jobId, AuthData authData, MailContainerResource data) {
    return null;
  }
