...
public class GoogleTransferExtension implements TransferExtension {
    ...
    private static final ImmutableList<DataVertical> SUPPORTED_SERVICES = ImmutableList.of(BLOBS, CALENDAR, CONTACTS, MAIL, PHOTOS, SOCIAL_POSTS, TASKS, VIDEOS, MEDIA);
    ...
    public void initialize(ExtensionContext context) {
        ...
        exporterBuilder.put(MEDIA, new GoogleMediaExporter(credentialFactory, jobStore, jsonFactory, monitor));
