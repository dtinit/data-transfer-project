...
public class GoogleCalendarExporterTest {
    ...
    private static final CalendarListEntry CALENDAR_LIST_ENTRY = new CalendarListEntry().setId(CALENDAR_ID);
    ...
    private void setUpSingleCalendarResponse() throws IOException {
        setUpSingleEventResponse();
        calendarListResponse = new CalendarList().setItems(Collections.singletonList(CALENDAR_LIST_ENTRY));
