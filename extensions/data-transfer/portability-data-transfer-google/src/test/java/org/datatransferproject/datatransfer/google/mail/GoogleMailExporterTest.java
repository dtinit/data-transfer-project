...
public class GoogleMailExporterTest {
    ...
    private static final Message FULL_MESSAGE = new Message().setId(MESSAGE_ID).setRaw(MESSAGE_RAW).setLabelIds(MESSAGE_LABELS);
    ...
    private void setUpSingleMessageResponse() throws IOException {
        messageListResponse = new ListMessagesResponse().setMessages(Collections.singletonList(INITIAL_MESSAGE));
