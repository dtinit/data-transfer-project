...
public class RememberTheMilkSignatureGeneratorTest {
    ...
    private static final RememberTheMilkSignatureGenerator SIGNATURE_GENERATOR = new RememberTheMilkSignatureGenerator(APP_CREDENTIALS, TOKEN);

    @Test
    public void signatureTest() throws Exception {
        String base = "http://example.com";
        Map<String, String> queryParams = ImmutableMap.of("yxz", "foo", "feg", "bar", "abc", "baz");
        URL expected = new URL(base + "?abc=baz&api_key=BANANAS1&auth_token=BANANAS3&feg=bar&yxz=foo&api_sig=b48f0dd1a18179b3068b16728e214561");
