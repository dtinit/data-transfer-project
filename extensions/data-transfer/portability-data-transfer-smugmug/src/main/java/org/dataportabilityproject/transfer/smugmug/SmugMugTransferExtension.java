...
public class SmugMugTransferExtension implements TransferExtension {
  ...
  public Exporter<?, ?> getExporter(String transferDataType) {
    Preconditions.checkArgument(initialized, "Trying to call getExporter before initalizing SmugMugTransferExtension");
    Preconditions.checkArgument(supportedTypes.contains(transferDataType), "Export of " + transferDataType + " not supported by SmugMug");
    return exporter;
  }

  @Override
  public Importer<?, ?> getImporter(String transferDataType) {
    Preconditions.checkArgument(initialized, "Trying to call getImporter before initalizing SmugMugTransferExtension");
    Preconditions.checkArgument(supportedTypes.contains(transferDataType), "Import of " + transferDataType + " not supported by SmugMug");
    return importer;
  }
  ...
  public void initialize(ExtensionContext context) {
    ...
    exporter = new SmugMugPhotosExporter(transport);
    importer = new SmugMugPhotosImporter(jobStore, transport);
    initialized = true;
  }
}
