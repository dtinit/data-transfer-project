...
public class MicrosoftTransferExtension implements TransferExtension {
    ...
    private static final ImmutableList<DataVertical> SUPPORTED_IMPORT_SERVICES = ImmutableList.of(CALENDAR, CONTACTS, PHOTOS, MEDIA);

    private static final ImmutableList<DataVertical> SUPPORTED_EXPORT_SERVICES = ImmutableList.of(CALENDAR, CONTACTS, PHOTOS, MEDIA, OFFLINE_DATA);
    ...
    public void initialize(ExtensionContext context) {
        ...
        importBuilder.put(MEDIA, new MicrosoftMediaImporter(BASE_GRAPH_URL, client, mapper, jobStore, monitor, credentialFactory));
