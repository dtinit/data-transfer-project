...
public class MicrosoftPhotosExportTest {
    ...
    public void testExport() throws Exception {
        ...
        PhotoModel photo1 = resource.getPhotos().stream().filter(p->"image1".equals(p.getDataId())).findFirst().get();
        ...
        PhotoModel photo2 = resource.getPhotos().stream().filter(p->"image2".equals(p.getDataId())).findFirst().get();
