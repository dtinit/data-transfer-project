...
public class GoogleOAuthConfig implements OAuth2Config {
    ...
    public Map<DataVertical, Set<String>> getExportScopes() {
        return ImmutableMap.<DataVertical, Set<String>>builder().put(BLOBS, ImmutableSet.of("https://www.googleapis.com/auth/drive.readonly")).put(CALENDAR, ImmutableSet.of("https://www.googleapis.com/auth/calendar.readonly")).put(CONTACTS, ImmutableSet.of("https://www.googleapis.com/auth/contacts.readonly")).put(MAIL, ImmutableSet.of("https://www.googleapis.com/auth/gmail.readonly")).put(PHOTOS, ImmutableSet.of("https://www.googleapis.com/auth/photoslibrary.readonly")).// For G+
        put(SOCIAL_POSTS, ImmutableSet.of("https://www.googleapis.com/auth/plus.login")).put(TASKS, ImmutableSet.of("https://www.googleapis.com/auth/tasks.readonly")).put(VIDEOS, ImmutableSet.of("https://www.googleapis.com/auth/photoslibrary.readonly")).build();
    }

    // See https://developers.google.com/identity/protocols/googlescopes
    @Override
    public Map<DataVertical, Set<String>> getImportScopes() {
        return ImmutableMap.<DataVertical, Set<String>>builder().put(BLOBS, ImmutableSet.of("https://www.googleapis.com/auth/drive")).put(CALENDAR, ImmutableSet.of("https://www.googleapis.com/auth/calendar")).put(CONTACTS, ImmutableSet.of("https://www.googleapis.com/auth/contacts")).put(MAIL, ImmutableSet.of("https://www.googleapis.com/auth/gmail.modify")).put(PHOTOS, ImmutableSet.of("https://www.googleapis.com/auth/photoslibrary.appendonly")).put(TASKS, ImmutableSet.of("https://www.googleapis.com/auth/tasks")).put(VIDEOS, ImmutableSet.of("https://www.googleapis.com/auth/photoslibrary")).build();
    }
