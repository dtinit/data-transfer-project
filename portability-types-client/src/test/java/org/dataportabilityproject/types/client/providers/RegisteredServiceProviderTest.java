  ...
  public void verifySerializeDeserialize() throws Exception {
    ...
    RegisteredServiceProvider provider =
        new RegisteredServiceProvider(
            "123", "TestProvider", "Test description", new String[] {"testContent"});
    String serialized = objectMapper.writeValueAsString(provider);

    RegisteredServiceProvider deserialized =
        objectMapper.readValue(serialized, RegisteredServiceProvider.class);
