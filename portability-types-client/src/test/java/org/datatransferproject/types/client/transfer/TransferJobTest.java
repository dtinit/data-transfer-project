...
public class TransferJobTest {
    ...
    public void verifySerializeDeserialize() throws Exception {
        ...
        TransferJob transfer = new TransferJob("1-2-3", "testExportService", "testImportService", PHOTOS, "exportUrl", "importUrl", "exportTokenUrl", "importTokenUrl", PortabilityCommon.AuthProtocol.OAUTH_1, PortabilityCommon.AuthProtocol.OAUTH_2);
