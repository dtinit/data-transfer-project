...
public class TransferJob {
    ...
    public enum State {
        ...
        CREATED, SUBMITTED, IN_PROGRESS, COMPLETE
    }
    ...
    @JsonCreator
    public TransferJob(@JsonProperty(value = "id", required = true) String id, @JsonProperty(value = "exportService", required = true) String exportService, @JsonProperty(value = "importService", required = true) String importService, @JsonProperty(value = "dataType", required = true) DataVertical dataType, @JsonProperty(value = "exportUrl", required = true) String exportUrl, @JsonProperty(value = "importUrl", required = true) String importUrl, @JsonProperty(value = "exportTokenUrl", required = true) String exportTokenUrl, @JsonProperty(value = "importTokenUrl", required = true) String importTokenUrl, @JsonProperty(value = "exportAuthProtocol", required = true) AuthProtocol exportAuthProtocol, @JsonProperty(value = "importAuthProtocol", required = true) AuthProtocol importAuthProtocol) {
        this.id = id;
